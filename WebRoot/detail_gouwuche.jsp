...
<% 
	String price_new=(String)session.getAttribute("price_new");
	String seller_sum=(String)session.getAttribute("seller_sum");
	Float sum=Float.parseFloat(price_new)*Float.parseFloat(seller_sum);
%>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="stylesheet" href="css/detail_gouwuche.css">	
</head>
<body>
	<div class="header">
		<div class="content">
	...
	<div class="content">
		...
		<div class="goods_detail_wrap">
			<div class="goods_detail">
				<div class="img_wrap">
					<img src="${gouwuche_s.imgurl}" class="img_goods" alt="">
					<div class="goods_title_wrap"><div class="goods_title">${gouwuche_s.goodsname}</div></div>
				</div>
				<div class="detail">
					<div class="dian_title"><a href="#">${gouwuche_s.storename}</a></div>
					<div class="info">
						<span>已添加商品：尺寸:<em class="size">${size}</em> 数量:<em class="sum">${seller_sum}</em></span>
					</div>
				</div>
			</div>
		</div>
		<div class="right_wrap">
			<div class="right">
				<div class="success">
					<i class="edit"></i>已成功加入购物车
				</div>
				<div class="price_sum">
					小计：<span>￥<em class="price"><%=sum %></em></span>
				</div>
				<div class="btns">
					<a href="#" class="back_btn">返回商品详情</a>
					<a href="#" class="gouwuche_btn">去购物车结算</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="js/detail_gouwuche.js"></script>
